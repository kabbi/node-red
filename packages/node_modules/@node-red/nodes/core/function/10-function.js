...
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        try {
            ...
            function processMessage(msg, send, done, port) {
            ...
            node.on("input", function(msg,send,done,port) {
                if(state === RESOLVING) {
                    messages.push({msg:msg, send:send, done:done, port:port});
                }
                else if(state === RESOLVED) {
                    processMessage(msg, send, done, port);
                }
            });
